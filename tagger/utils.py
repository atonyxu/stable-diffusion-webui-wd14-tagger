...
)  # pylint: disable=E0401 # noqa: E501
from tagger.interrogator import (
...
interrogators: Dict[str, Interrogator] = {
    "wd14-vit.v1": WaifuDiffusionInterrogator(
        "WD14 ViT v1", repo_id="fireicewolf/wd-v1-4-vit-tagger"
    ),
    "wd-eva02-large-tagger-v3": WaifuDiffusionInterrogator(
        "wd-eva02-large-tagger-v3", repo_id="fireicewolf/wd-eva02-large-tagger-v3"
    ),
    "wd-swinv2-tagger-v3": WaifuDiffusionInterrogator(
        "wd-swinv2-tagger-v3", repo_id="fireicewolf/wd-swinv2-tagger-v3"
    ),
    "wd-convnext-tagger-v3": WaifuDiffusionInterrogator(
        "wd-convnext-tagger-v3", repo_id="fireicewolf/wd-convnext-tagger-v3"
    ),
    "wd-vit-tagger-v3": WaifuDiffusionInterrogator(
        "wd-vit-tagger-v3", repo_id="fireicewolf/wd-vit-tagger-v3"
    ),
    "wd-vit-large-tagger-v3": WaifuDiffusionInterrogator(
        "wd-vit-large-tagger-v3", repo_id="fireicewolf/wd-vit-large-tagger-v3"
    ),
    "e621-convnext-tagger": WaifuDiffusionInterrogator(
        "e621-convnext-tagger", repo_id="atonyxu/e621-convnext-tagger"
    ),
    "wd14-vit.v2": WaifuDiffusionInterrogator(
        "WD14 ViT v2",
        repo_id="fireicewolf/wd-v1-4-vit-tagger-v2",
    ),
    "wd14-convnext.v1": WaifuDiffusionInterrogator(
        "WD14 ConvNeXT v1", repo_id="fireicewolf/wd-v1-4-convnext-tagger"
    ),
    "wd14-convnext.v2": WaifuDiffusionInterrogator(
        "WD14 ConvNeXT v2",
        repo_id="fireicewolf/wd-v1-4-convnext-tagger-v2",
    ),
    "wd14-convnextv2.v1": WaifuDiffusionInterrogator(
        "WD14 ConvNeXTV2 v1",
        # the name is misleading, but it's v1
        repo_id="fireicewolf/wd-v1-4-convnextv2-tagger-v2",
    ),
    "wd14-swinv2-v1": WaifuDiffusionInterrogator(
        "WD14 SwinV2 v1",
        # again misleading name
        repo_id="fireicewolf/wd-v1-4-swinv2-tagger-v2",
    ),
    "wd-v1-4-moat-tagger.v2": WaifuDiffusionInterrogator(
        "WD14 moat tagger v2", repo_id="fireicewolf/wd-v1-4-moat-tagger-v2"
    ),
        ...
        if path.name not in interrogators:
            if path.name == "wd-v1-4-convnextv2-tagger-v2":
                interrogators[path.name] = WaifuDiffusionInterrogator(
                    path.name, repo_id="fireicewolf/SW-CV-ModelZoo", is_hf=False
                )
